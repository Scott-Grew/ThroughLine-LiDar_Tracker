...
// the tracker, which adds dropout, position noise and arrival latency.
...
// Fault rates for one run. The position noise sigma is in metres and
// the arrival delay in microseconds.
